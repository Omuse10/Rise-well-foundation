          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div className="col-span-1 md:col-span-2">
              ...
              <div className="flex space-x-4">
                ...
                <a href="https://x.com/RisewellK34553" target="_blank" rel="noopener noreferrer" className="bg-gray-800 p-2 rounded-full hover:bg-gray-700 cursor-pointer transition-colors">
                  <Twitter className="h-5 w-5 text-white" />
                </a>
                <a href="https://www.linkedin.com/in/rise-well-b70597397/" target="_blank" rel="noopener noreferrer" className="bg-gray-800 p-2 rounded-full hover:bg-gray-700 cursor-pointer transition-colors">
